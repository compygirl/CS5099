...
# ##
# ## 1. compares two solutions and returns matrix with differences;
# ##
# ## 2. compares the matrix with differences with original matrix and returns
# ##    the number of differences;
# ##
# ## 3. after the places with differences in the matrix was obtained, the original
...
def update_instances(orig_sol_board, difference_m, param_directory, image_filename):
    ...
    # run the loop where the copy of solution board will be created
    # with only one pixec update
    print "COUNT: ", count
    print "NUM", num_of_diff
