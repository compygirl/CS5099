...
# ##  1. based on the solution board create instance's top matrix and left matrix;
# ##
# ##  2. After getting top and left matrices create a content of param files;
# ##
# ##     The obtained content will be used by the file_manager to create instance file.
# # ####################################################################################
