...
def test_random_instances():
    ...
    for i in range(0, num_files):
        ...
        print("{: >20} {: >20}: {: >20}".format("Num of Solutions: ", param_filename,
            info_dict['SolverSolutionsFound']))
        print("{: >20} {: >20}: {: >20}".format("Num of Nodes:", param_filename,
            info_dict['SolverNodes']))
        print("{: >20} {: >20}: {: >20}".format("Solver Total Time:", param_filename,
            info_dict['SolverTotalTime']))
        print("{: >20} {: >20}: {: >20}".format("Solve Time:", param_filename,
            info_dict['SolverSolveTime']))
        print("{: >20} {: >20}: {: >20}".format("SavileRow Total time:", param_filename,
            info_dict['SavileRowTotalTime']))
