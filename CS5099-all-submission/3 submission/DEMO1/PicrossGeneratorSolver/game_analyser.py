...
def execute_savileRow(eprime_filename, param_directory, param_filename):
    ...
    # call(["zsh", "-c", "savilerow " ""+eprime_filename+" "+param_directory+"/" +param_filename+" -run-solver -num-solutions 5 -solver-options '-varorder conflict -prop-node SACBounds'"])
    call(["zsh", "-c", "savilerow " ""+eprime_filename+" "+param_directory+"/" +param_filename+" -run-solver -num-solutions 5 -solver-options '-cpulimit 20 -varorder conflict -prop-node SACBounds'"])
